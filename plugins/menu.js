...
├➸${prefix}𝙫𝙞𝙙𝙚𝙤  
├➸${prefix}𝙥𝙡𝙖𝙮𝙙𝙤𝙘  
├➸${prefix}𝙥𝙡𝙖𝙮3 _(DOWNLOAD DE AUDIO EM DOCUMENTO)_  
├➸${prefix}𝙥𝙡𝙖𝙮4 _(DOWNLOAD DE VIDEO EM DOCUMENTO)_  
├➸${prefix}𝙮𝙩𝙨 _(BUSCAR VIDEO)_  
├➸${prefix}𝙮𝙩𝙢𝙥3 _(LINK PARA BAIXARO AUDIO)_  
├➸${prefix}𝙮𝙩𝙢𝙥4 _(LINK PARA ABAIXAR O VIDEO)_  
├➸${prefix}𝙨𝙥𝙤𝙩𝙞𝙛𝙮  
├➸${prefix}𝙢𝙪𝙨𝙞𝙘 _(ABAIXAR MUSICA DO SPOTIFY)_  
├➸${prefix}𝙜𝙞𝙩𝙘𝙡𝙤𝙣𝙚 _(ABAIXAR REPOSITORIO DO GITHUB)_  
├➸${prefix}𝙩𝙞𝙠𝙩𝙤𝙠 _(ABAIXAR VIDEO DO TIKTOK)_  
├➸${prefix}𝙩𝙞𝙠𝙩𝙤𝙠𝙞𝙢𝙜  
├➸${prefix}𝙩𝙩𝙞𝙢𝙜 _(ABAIXAR IMAGEM DO TIKTOK)_  
├➸${prefix}𝙞𝙜𝙨𝙩𝙖𝙡𝙠 _(NOME DE UM USUÁRIO DO INSTAGRAM)_  
├➸${prefix}𝙛𝙖𝙘𝙚𝙗𝙤𝙤𝙠  
├➸${prefix}𝙛𝙗 _(ABAIXAR FOTO DO FACEBOOK)_  
├➸${prefix}𝙞𝙣𝙨𝙩𝙖𝙜𝙧𝙖𝙢  
├➸${prefix}𝙞𝙜 _(ABAIXAR FOTOS DO INSTAGRAM)_  
├➸${prefix}𝙢𝙚𝙙𝙞𝙖𝙛𝙞𝙧𝙚 _(ABAIXAR ARQUIVOS DO MEDIAFIRE)_  
├➸${prefix}𝙩𝙞𝙠𝙩𝙤𝙠𝙨𝙩𝙖𝙡𝙠 _(NOME DE USUARIO DO TTK)_  
├➸${prefix}𝙩𝙬𝙞𝙩𝙩𝙚𝙧  
├➸${prefix}𝙭 _(ABAIXAR UM VIDEO DO TWITTER (𝙓)_  
├➸${prefix}𝙜𝙙𝙧𝙞𝙫𝙚 _(ABAIXAR ARQUIVOS DO 𝙂𝘿𝙧𝙞𝙫𝙚)_  
┗━━━━━━━━━━━━━━━┛`
...
┊┃ ❏ ${prefix}𝑖𝑛𝑓𝑜𝑔𝑟𝑢𝑝𝑜
┊┃ ❏ ${prefix}𝑔𝑟𝑜𝑢𝑝𝑖𝑛𝑓𝑜
┊┃ ❏ ${prefix}𝑎𝑑𝑚𝑖𝑛𝑠 _(𝑖𝑛𝑣𝑜𝑐𝑎𝑟 𝑙𝑜𝑠 𝑎𝑑𝑚𝑖𝑛𝑠)_
